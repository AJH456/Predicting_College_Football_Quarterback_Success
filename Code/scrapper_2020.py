...
RANKINGS_URL = "https://247sports.com/season/2020-football/RecruitRankings/?InstitutionGroup=highschool&PositionGroup=QB"
...
def get_player_urls(page):
    ...
    while True:
        if page_num == 1:
            ...
            url = (
                f"{BASE_URL}/season/2020-football/RecruitRankings/?InstitutionGroup=highschool&PositionGroup=QB/"
...
with sync_playwright() as p:
    ...
    # Step 3: Final save
    with open("scouting_reports_2020.json", "w", encoding="utf-8") as f:
        json.dump(players, f, indent=2, ensure_ascii=False)
    print(f"\nDone! Saved {len(players)} players to scouting_reports_2020.json")
